  ...
  <Layout>
    <div class="px-6 py-8">
      <div class="flex justify-between items-center mb-6">
        <h3 class="text-primary font-bold text-3xl">Créer une nouvelle bannière</h3>
        <button
          @click="goBack"
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <div v-if="imagePreview" class="mt-2">
                ...
                />
                <p class="text-sm text-green-600 mt-1">Aperçu de l'image</p>
              </div>
          ...
          <div class="flex justify-end gap-3 pt-6">
            ...
            >
              ...
              {{ isLoading ? 'Création...' : 'Créer la bannière' }}
            </button>
          </div>
        </form>
      </div>
...
const handleSubmit = () => {
  ...
  if (!form.value.image) {
    errors.value.image = 'Une image est requise'
    return
  }
