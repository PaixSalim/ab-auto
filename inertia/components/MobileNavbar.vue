  ...
  <header class="md:hidden px-4 sticky top-0 bg-white z-50">
    <div class="flex items-center gap-4 max-w-7xl mx-auto py-2">
      <div class="flex w-full items-center gap-2">
        ...
        <div v-if="!isExpanded && user" class="flex items-center gap-2 flex-none">
          <Link href="/orders" class="text-gray-700 hover:text-primary">
            <div class="i-mdi-shopping h-6 w-6" />
          </Link>
          <Link href="/comments" class="text-gray-700 hover:text-primary">
            <div class="i-mdi-comment h-6 w-6" />
          </Link>
          <Link href="/auth/logout" method="post" as="button" class="text-gray-700 hover:text-primary">
