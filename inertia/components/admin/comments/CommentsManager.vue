...
const share = usePage()
// État
const comments = ref<CommentResponse[]>(share.props.comments)
const products = ref<ProductDto[]>(share.props.products)
...
const fetchData = async () => {
  try {
    ...
    // Simulation d'appel API pour les produits
    //await new Promise(resolve => setTimeout(resolve, 500))

    // Simulation d'appel API pour les commentaires
    //await new Promise(resolve => setTimeout(resolve, 500))
  } catch (error) {
